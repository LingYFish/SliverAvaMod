...
class ItemStack(object):
    ...
    def __init__(self, **kwargs):
        self.identifier = kwargs.get('newItemName', 'minecraft:air')
        self.data = kwargs.get('newAuxValue', 0)
        self.count = kwargs.get('count', 1)
        self.tag = kwargs.get('userData', None) or {}
        self.extraId = kwargs.get('extraId', '')
        self.durability = kwargs.get('durability',0)
        self._tagConvert()
